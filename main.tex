...
\thanks{wishes to thank Dr. Panteleev Pavel for helpful clarification, guidance in methodology in the early stages of this work.}
...
over decoders independently, we can produce a generative model that produces Bivariate Bicycle (BB) codes based on the choice of decoder.
